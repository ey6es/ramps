...
public abstract class Ramp : MonoBehaviour {
  ...
  public virtual object OnTraverserEnter (RampTraverser traverser) {
    return null;
  }

  public virtual void OnTraverserStay (RampTraverser traverser, RaycastHit hitInfo, object data) {
